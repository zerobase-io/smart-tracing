      ...
      <Container className="container">
        <div className="card">
          <div className="card-body" id="body-healthcare-register">
            <h3 className="mb-5">Register your healthcare organization</h3>
            ...
            <div className="row">
              <div className="col-12 col-md-7">
                <form className="register-healthcare" onSubmit={onSubmit}>
                  ...
                  <div className="mb-2">
                    ...
                    >
                      <option value="HEALTH/DOCTOR_OFFICE">Hospital</option>
                      <option value="HEALTH/HOSPITAL">Doctor Office</option>
                      <option value="HEALTH/PHARMACY">Pharmacy</option>
                      <option value="HEALTH/OTHER">Other</option>
                    </select>
                  </div>
                  <div className="mb-3">
                    <label className="form-check">
                      <input
                        ...
                        onChange={handleHasTestingFacilitiesCheckbox}
                        checked={hasTestingFacilities}
                      />
                      <span className="form-check-label">
                        Our facility administers COVID-19 tests
                      </span>
                    </label>
                  </div>
              ...
              <div className="col-12 col-md-5">
                <div className="card mt-4">
                  ...
                  <div className="card-body">
                    <div className="small">
                      {' '}
                      Register below to receive your unique, single-use codes by
                      email. Print them out, attach to your intake forms.{' '}
                      <a href="/testing">Click to learn more.</a>
                    </div>
                  </div>
