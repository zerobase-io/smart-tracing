                                ...
                                <div className="card-img-overlay text-center d-flex align-items-center">
                                    <div className="container">
                                        ...
                                        <h3 className="text-white forScreen">
                                            Essential. Anonymous. Accessible to
                                            all.
                                        </h3>
                                        <a
                                        ...
                                        >
                                            ...
                                            Read Our Privacy-First Commitment
                                        </a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="row row-sm align-items-center shadow-none">
                                        ...
                                        <div className="col-md-8 col-12">
                                            ...
                                            <p className="lead lh-190">
                                                The Zerobase Foundation is a
                                                nonprofit organization whose
                                                mission is to build open source
                                                public health technology for the
                                                good of communities around the
                                                world. Our free, privacy-first
                                                contact tracing empowers both
                            ...
                            <div className="card hover-translate-y-n10 hover-shadow-lg">
                                ...
                                <div className="card-body">
                                    <h3 className="card-title">
                                        Business and Public Locations
                                    </h3>
                                    <p>
                                        Play a vital role in stopping the spread
                                        of coronavirus in your community by
                                        enabling anonymous check-ins at your
                                        door in seconds. Stay ahead of the curve
                        ...
                        >
                            <div className="card hover-translate-y-n10 hover-shadow-lg">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>
                                        Use our powerful tracing technology to
                                        maximize the value of every COVID-19
                                        test in your area and keep your
                                        community safe.
                                    </p>
                                </div>
                            </div>
                        ...
                        >
                            <div className="card hover-translate-y-n10 hover-shadow-lg">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>
                                        Use our smart contact tracing platform
                                        to get customized, deep insight into the
                                        local dynamics of the epidemic and
                                        provide instant, individualized guidance
