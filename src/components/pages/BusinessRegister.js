                ...
                <div className="card">
                    <div className="card-body" id="body-business-register">
                        ...
                        >
                            ...
                            please try again. Having trouble? Contact
                            info@zerobase.io.
                        </div>
                        <div
                            className="alert alert-warning d-none"
                                ...
                                >
                                    ...
                                    <div className="mb-2">
                                        ...
                                        >
                                            ...
                                            <option value="BUSINESS/RESTAURANT">
                                                Restaurant
                                            </option>
                                            <option value="FINANCIAL/BANK">
                                                Bank
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div className="col-12 col-md-5">
                                <div className="card mt-4">
                                    ...
                                    <div className="card-body">
                                        <div className="small">
                                            {' '}
                                            Register to receive your unique
                                            codes by email. Print them out,
                                            place them up at entrances, cash
                                            registers, any touchpoint.{' '}
                                            <a href="/businesses">
                                                Click to learn more.
                                            </a>
                                        </div>
