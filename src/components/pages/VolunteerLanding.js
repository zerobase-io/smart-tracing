      ...
      <div className="content pt-0">
          ...
          <div className="row m-2 mb-md-5">
            <div className="col-lg-12 col-12">
              <p className="lead lh-180" style={{ fontSize: '24px' }}>
                We are a free, privacy-first contact tracing platform that
                empowers both individuals and local officials to stop the spread
                of COVID-19 in a way that is private, easy to use, and helps to
                alleviate the manual issues involved in contact tracing and
                individualized testing. To learn more about zerobase and the
                importance of tracing, read our{' '}
        ...
        <div className="container px-4">
          ...
          <div className="row mt-5">
            <div className="col-12 text-center" style={{ fontSize: '30px' }}>
              <strong>Thank you for your interest in volunteering!</strong>
              <br />
              We are excited to have you!
            </div>
          </div>
          <div className="row mt-5 text-center mb-5">
            <div className="col-md-6 col-12" style={{ fontSize: '24px' }}>
              <strong>1. Fill out our our volunteer form</strong>
              <br />
              <a
                className="btn btn-lg btn-dark my-2"
                href="https://docs.google.com/forms/d/e/1FAIpQLSenbQaMHQTFyULEz7etYqM6X9sckrRwggbD5RMFqNpKT5AR4w/viewform"
                target="_blank"
              >
                Registration Form
              </a>
            ...
            >
              ...
              <a
                className="btn btn-lg btn-dark my-2"
                href="https://join.slack.com/t/necsi-edu/shared_invite/zt-d86ge6g0-sgLKgyhRpFBJq2VrnJOdhg"
                target="_blank"
              >
                Zerobase Slack
              </a>
          ...
          <div className="row mt-5 pb-4">
            <div className="col-12 text-center" style={{ fontSize: '30px' }}>
              <strong>
                Join a team! Here are some channels to get you started:
              </strong>
            </div>
          </div>
          ...
          <div className="row mt-5 pb-4">
            <div className="col-12 text-center" style={{ fontSize: '30px' }}>
              ...
              <a
                ...
                href="https://github.com/zerobase-io/About-Us-Onboarding"
                target="_blank"
              >
                Zerobase GitHub
              </a>
          ...
          <div className="row mt-5 pb-4">
            <div className="col-12" style={{ fontSize: '30px' }}>
              <strong>Any questions? Get stuck?</strong>
              <div className="form-inline">
                <p style={{ fontSize: '24px' }}>Email us at &nbsp;</p>
                <a className="text-nowrap" href="mailto://info@zerobase.io">
                  <p style={{ fontSize: '24px' }}>
                    <strong>info@zerobase.io &nbsp;</strong>
                  </p>
                </a>
                <p style={{ fontSize: '24px' }}>or ask in &nbsp;</p>
