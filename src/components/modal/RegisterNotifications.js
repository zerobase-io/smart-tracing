        ...
        >
          <div className="modal-content" style={{ minHeight: '90vh' }}>
            <div className="modal-header">
              <h5 className="modal-title">Opt-in for Notifications</h5>
              <button
                className="close"
                type="button"
                data-dismiss="modal"
            ...
            <div className="modal-body">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="text-center">
                    The best way for you to stay notified of possible exposure
                    is to securely share your phone number. If we don't have
                    access to your phone number, we'll still try to notify you
                    the next time you check in to any location. We keep your
                    information safe and are proud to put your privacy first.
                    Please read our Privacy Policy before accepting and
                    proceeding.
                  </p>
                </div>
              </div>
              <div
                ...
                id="notify-warning"
              >
                <i className="fe fe-alert-triangle mr-2"></i>Please accept the
                privacy policy and enter a valid phone number
              </div>
              <div
                ...
                id="notify-success"
              >
                <i className="fe fe-check mr-2"></i>You are now registered for
                alerts.
              </div>
              <div className="input-group mb-0 mt-4">
                <span className="input-group-text">
                  <input
                    ...
                    id="notify-agree"
                  />
                  <a className="ml-2 text-blue" id="privacy-policy">
                    Privacy Policy
                  </a>
                </span>
                <input
