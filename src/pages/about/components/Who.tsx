    ...
    <>
        ...
        <Row className="mb-5" md={2} xs={1}>
            ...
            <Col className="text-center text-md-left">
                ...
                <p>
                    Zerobase enables local communities to establish their first line of defense against COVID-19
                    outbreaks in a way that is private, easy to use, and helps to alleviate the manual issues involved
                    in contact tracing and individualized testing.
                </p>
                <Button variant="outline-s-indigo" href="https://www.who.int/news-room/q-a-detail/contact-tracing">
