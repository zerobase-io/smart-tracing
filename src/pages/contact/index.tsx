    ...
    <Container className="my-5">
      <Row className="justify-content-center">
        <Col xs={7}>
          ...
          <p>
            Want to know more about Zerobase or how you can get started? Do you
            have feedback for how we can help you better? We want to hear from
            you!
          </p>
          <p>
            Any <strong>optional</strong> personal information provided is not
            associated with an account, and is only used so we can get back to
            you.
          </p>
        </Col>
      </Row>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Row>
              <Form.Group as={Col} controlId="email" xs={6}>
                ...
                <Form.Text>
                  <strong>Optional</strong> - if you would like a response from
                  us
                </Form.Text>
                <Form.Control
                  name="email"
