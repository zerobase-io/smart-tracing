...
import ProfileCard, {
  ProfileCardProps,
} from "@/components/Cards/ProfileCard/ProfileCard";
...
const Team = () => (
  ...
  >
    <Row>
      <Col>
        <p className="h4 lead text-p-dark">
          The Zerobase Foundation is an international nonprofit organization of
          volunteer technologists, business leaders, medical professionals, and
          concerned citizens. Zerobase builds free and open source public health
    ...
    <Row className="align-items-middle justify-content-center">
      ...
      <Col lg={6}>
        <p className="px-5">
          Aron leads the Zerobase Foundation team. Aron’s background is in the
          study of the spread of misinformation through social networks. He
          holds dual research and engineering appointments at Harvard University
          and Kensho Technologies, where his work lies at the intersection of
          machine learning on networks and natural language processing. Aron
          completed undergraduate and graduate study in applied mathematics at
          Harvard University.
        </p>
      </Col>
    </Row>
    ...
    <Row className="justify-content-center text-p-black">
      <Col xs={10}>
        <p className="lead">
          The Zerobase team comprises over 150 volunteers from dozens of
          countries around the world, including technologists, medical
          professionals, attorneys, political activists, and concerned citizens.
          No matter who or where you are, you can make an immediate impact on
          our efforts to bring free and accessible public health technology to
    ...
    <Row
      className="align-items-center h-200 justify-content-center text-center"
      lg={3}
      xs={1}
    >
      <Col className="py-3">
        <a href="https://datascience.harvard.edu/">
          <Image
            alt="Harvard Data Science Intitiative logo"
            src={PartnerHDSI}
            height={200}
          />
        </a>
