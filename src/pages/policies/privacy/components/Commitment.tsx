...
const Commitment = () => (
    <>
        <Row className="mb-3 mb-md-0 text-p-dark" lg={2} xs={1}>
            ...
            <Col>
                <p className="lead">
                    Unlike other contact tracing mechanisms developed so far, Zerobase does not track GPS locations or
                    require downloading an application to your phone.
                </p>
                <p className="lead">
        ...
        <Row className="mb-3 mb-md-0 text-p-dark" lg={2} xs={1}>
            ...
            <Col>
                <p className="lead">
                    The best way for you to stay notified in real time of possible exposure is to securely share your
                    phone number. If we don't have access to your phone number, we'll still try to notify you the next
                    time you check in to any location, but it will take longer to let you know that you may have been
                    exposed.
                </p>
