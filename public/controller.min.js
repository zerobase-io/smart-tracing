...
$("#modal-scan-notice").modal("show");router.fetchIP({sdvid:m},function(a){router.fingerprint(a,function(a){router.create(a,function(a){router.scan(a,function(a){router.init()})})})})}))):("s"==b?(console.log("Invalid Access Point"),window.history.replaceState({},"Home","/")):console.log("No Conditions Met"),router.init());$("body").on("click","#landing-about",function(a){console.log("hello");$('a[href="#tabs-about"]').tab("show")});$("body").on("click","#landing-generate",function(a){localStorage.getItem("dvid")?
